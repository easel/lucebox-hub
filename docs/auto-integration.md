...
Last refresh: `2026-05-31T11:56:00-04:00`
Current base: `origin/main` `8305b6c2`
Previous integration tip: `easel/auto-integration` `34658ab5`
Current integration source tip before this refresh: `34658ab5`
...
- Validation for the post-push fast-follow: `git diff --check HEAD~2..HEAD` passed. Full CMake validation was not rerun because the checkout still lacks populated `server/deps/llama.cpp` and the known CUDA compiler-id `sm_52` toolchain blocker remains for full project configure.
