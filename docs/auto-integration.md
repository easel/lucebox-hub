...
- `date -Is` -> `2026-05-29T22:49:03-04:00` during preflight and manifest refresh.
...
- Fresh probe worktrees attempted direct merges for every non-integrated non-draft PR. All eight still conflict in old-layout or dependent MTP/scheduler areas; logs are retained under `/tmp/luce-auto-cron-20260529-224903/probes/pr-*-merge.log`, status snapshots under `/tmp/luce-auto-cron-20260529-224903/probes/pr-*-status.txt`, and conflict-file lists under `/tmp/luce-auto-cron-20260529-224903/probes/pr-*-conflicts.txt`.
...
- `/tmp/luce-auto-cron-20260529-224903/reconcile`
- `/tmp/luce-auto-cron-20260529-224903/probes/pr-237-probe`
- `/tmp/luce-auto-cron-20260529-224903/probes/pr-221-probe`
- `/tmp/luce-auto-cron-20260529-224903/probes/pr-154-probe`
- `/tmp/luce-auto-cron-20260529-224903/probes/pr-153-probe`
- `/tmp/luce-auto-cron-20260529-224903/probes/pr-137-probe`
- `/tmp/luce-auto-cron-20260529-224903/probes/pr-135-probe`
- `/tmp/luce-auto-cron-20260529-224903/probes/pr-94-probe`
- `/tmp/luce-auto-cron-20260529-224903/probes/pr-48-probe`
- `/tmp/luce-auto-cron-20260529-224903/probes/pr-*-merge.log`
- `/tmp/luce-auto-cron-20260529-224903/probes/pr-*-status.txt`
- `/tmp/luce-auto-cron-20260529-224903/probes/pr-*-conflicts.txt`
