...
Last refresh: 2026-05-30T00:33:36-04:00
Current base: `origin/main` `8782d07a`
Current integration tip before this refresh: `easel/auto-integration` `48fae399`
Manifest refresh and unresolved-PR probe update prepared in this run: this commit

This branch is maintained as a reproducible patch stack over `origin/main`. This unattended run started from a clean primary checkout on `auto-integration`, verified GitHub/Claude/Codex auth with the real user credential home, fetched `origin` and `easel` separately, confirmed `origin/main` was already included, and performed fresh direct-merge probing in `/tmp/luce-auto-cron-20260530-003336/probes/pr-*-probe` worktrees.
...
- `date -Is` -> `2026-05-30T00:32:50-04:00` during preflight and `2026-05-30T00:33:36-04:00` for the reconciliation worktree name / manifest refresh.
...
- Fresh probe worktrees attempted direct merges for every non-integrated non-draft PR. All eight still conflict in old-layout or dependent MTP/scheduler areas; logs are retained under `/tmp/luce-auto-cron-20260530-003336/probes/pr-*-merge.log`, status snapshots under `/tmp/luce-auto-cron-20260530-003336/probes/pr-*-status.txt`, and conflict-file lists under `/tmp/luce-auto-cron-20260530-003336/probes/pr-*-conflicts.txt`.
...
- `/tmp/luce-auto-cron-20260530-003336/probes/pr-237-probe`
- `/tmp/luce-auto-cron-20260530-003336/probes/pr-221-probe`
- `/tmp/luce-auto-cron-20260530-003336/probes/pr-154-probe`
- `/tmp/luce-auto-cron-20260530-003336/probes/pr-153-probe`
- `/tmp/luce-auto-cron-20260530-003336/probes/pr-137-probe`
- `/tmp/luce-auto-cron-20260530-003336/probes/pr-135-probe`
- `/tmp/luce-auto-cron-20260530-003336/probes/pr-94-probe`
- `/tmp/luce-auto-cron-20260530-003336/probes/pr-48-probe`
- `/tmp/luce-auto-cron-20260530-003336/probes/pr-*-merge.log`
- `/tmp/luce-auto-cron-20260530-003336/probes/pr-*-status.txt`
- `/tmp/luce-auto-cron-20260530-003336/probes/pr-*-conflicts.txt`
