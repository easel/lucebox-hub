...
//
// This header intentionally exposes only the inert client/daemon contract used
// by staged mixed-backend layer-split ports. The implementation and runtime
// activation are integrated separately once the current-layout adapter wiring is
// reconciled.
