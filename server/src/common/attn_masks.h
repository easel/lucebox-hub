...
// fixed kv extent (for example build_target_step_tree sizing sg.attn_mask at
// align_up(cache.max_ctx + N, kq_stride_pad)) and the helper-computed stride
// would not match the tensor's actual row pitch. Default 0 keeps existing
// behavior.
